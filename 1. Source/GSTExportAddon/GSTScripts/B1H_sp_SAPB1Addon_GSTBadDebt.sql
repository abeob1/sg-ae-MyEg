create PROCEDURE sp_SAPB1Addon_GSTBadDebt
--**{0}**--
(
	IN Date Date,
...
BEGIN
	...
	(select "U_Value" from "@GSTSETUP" where "Code"='ACT2') as "CrAct",
	(
	select "Account" from "OVTG" where "Code"=
		(select "U_Value" from "@GSTSETUP" where "Code"='ARInTaxCode')
	) as "DrAct",
	
	(select "U_Value" from "@GSTSETUP" where "Code"='ARInTaxCode') as "TaxCode",
