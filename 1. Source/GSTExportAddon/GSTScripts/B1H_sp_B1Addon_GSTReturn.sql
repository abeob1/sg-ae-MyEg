drop  PROCEDURE sp_B1Addon_GSTReturn;
...
BEGIN
	...
	select "TaxIdNum","CompnyName",fromdate,todate,todate from "OADM";
	
	create local temporary table #TBLTEMP2(
		PointAt nvarchar(10), 
		TransID decimal, 
...
IF :pointat='5a' or :pointat='A' or :pointat='All' THEN
	...
	END IF;
	update #GST03DATATBL set Point5a=(Select SUM(BaseSum) from #TBLTEMP2 where PointAt='5a');
----------------END POINT 5a-----------------
...
update #GST03DATATBL set Point5b=(select SUM(Balance) from #TBLTEMP2 where PointAt='5b');
----------------END POINT 5b-----------------
...
update #GST03DATATBL set Point6a=(select SUM(BaseSum) from #TBLTEMP2 where PointAt='6a');
----------------END POINT 6a-----------------
...
update #GST03DATATBL set Point6b=(select SUM(Balance) from #TBLTEMP2 where PointAt='6b');
----------------END POINT 6b-----------------
...
update #GST03DATATBL set Point10=(select SUM(BaseSum) from #TBLTEMP2 where PointAt='10');
----------------END POINT 10-----------------
...
update #GST03DATATBL set Point11=(select SUM(BaseSum) from #TBLTEMP2 where PointAt='11');
----------------END POINT 11-----------------
...
update #GST03DATATBL set Point12=(select SUM(BaseSum) from #TBLTEMP2 where PointAt='12');
----------------END POINT 12-----------------
...
update #GST03DATATBL set Point13=(select SUM(BaseSum) from #TBLTEMP2 where PointAt='13');
----------------END POINT 13-----------------
...
update #GST03DATATBL set Point14=(select SUM(Balance) from #TBLTEMP2 where PointAt='14');
------------------END POINT 14-----------------
...
update #GST03DATATBL set Point15=(select SUM(BaseSum) from #TBLTEMP2 where PointAt='15');
------------------END POINT 15-----------------
...
update #GST03DATATBL set Point16=(select SUM(Balance) from #TBLTEMP2 where PointAt='16');
------------------END POINT 16-----------------
...
update #GST03DATATBL set Point17=(select SUM(Balance+BaseSum) from #TBLTEMP2 where PointAt='17');
------------END POINT 17------------
...
update #GST03DATATBL set Point18=(select SUM(Balance+BaseSum) from #TBLTEMP2 where PointAt='18');
------------END POINT 18------------
...
------------------BEGIN POINT 19-----------------
	...
	select 
		ifnull(CAST(point5a as nvarchar(100)),'0.00') || Char(124) ||
		ifnull(CAST(point5b as nvarchar(100)),'0.00') || Char(124) ||
		ifnull(CAST(point6a  as nvarchar(100)),'0.00') || Char(124) ||
		ifnull(CAST(point6b as nvarchar(100)),'0.00') || Char(124) || '1' || Char(124) ||		
		ifnull(CAST(point10 as nvarchar(100)),'0.00') || Char(124) ||
		ifnull(CAST(point11 as nvarchar(100)),'0.00') || Char(124) ||
		ifnull(CAST(point12 as nvarchar(100)),'0.00') || Char(124) ||
		ifnull(CAST(point13 as nvarchar(100)),'0.00') || Char(124) ||
		ifnull(CAST(point14 as nvarchar(100)),'0.00') || Char(124) ||
		ifnull(CAST(point15 as nvarchar(100)),'0.00') || Char(124) ||
		ifnull(CAST(point16 as nvarchar(100)),'0.00') || Char(124) ||
		ifnull(CAST(point17 as nvarchar(100)),'0.00') || Char(124) ||
		--ifnull(CAST(point18 as nvarchar(100)),'0.00') || Char(124) ||

		ifnull(CAST(Point19_1Code as nvarchar(100)),'')|| Char(124) ||
		ifnull(CAST(Point19_1Value/100 as nvarchar(100)),'0.00')|| Char(124) ||
		ifnull(CAST(Point19_2Code as nvarchar(100)),'')|| Char(124) ||
		ifnull(CAST(Point19_2Value/100 as nvarchar(100)),'0.00')|| Char(124) ||
		ifnull(CAST(Point19_3Code as nvarchar(100)),'')|| Char(124) ||
		ifnull(CAST(Point19_3Value/100 as nvarchar(100)),'0.00')|| Char(124) ||
		ifnull(CAST(Point19_4Code as nvarchar(100)),'')|| Char(124) ||
		ifnull(CAST(Point19_4Value/100 as nvarchar(100)),'0.00')|| Char(124) ||
		ifnull(CAST(Point19_5Code as nvarchar(100)),'')|| Char(124) ||
		ifnull(CAST(Point19_5Value/100 as nvarchar(100)),'0.00') || Char(124) || '0' as "txtFilestr"
	from #GST03DATATBL;
