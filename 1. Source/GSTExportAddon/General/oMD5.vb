...
Public Class oMD5
    ...
    Private Shared m_strPassPhrase As String = "$$FRANK$$"    '---- any text string is good here
    ...
    Public Shared Function EncryptPassword(ByVal Password As String) As String
        ...
        Try
            sEncryptedPassword = oMD5.EncryptPasswordMD5(Password, sEncryptKey)
    ...
    Public Shared Function DecryptPassword(ByVal Password As String) As String
        ...
        Try
            sDecryptedPassword = oMD5.DecryptPasswordMD5(Password, sEncryptKey)
