...
Namespace AddOnInstaller
    ...
    Public Class AddOnInstallInfo
        ...
        Public Sub New()
            MyBase.New
            'INITIALIZATION CODE	...
            AddOnName = "AE_MYEG_IN01"
            PartnerName = "Abeo"
            RestartNeeded = False
            ExeFile = "AE_MYEG_AV01.exe"
            ExtraFiles = New String() {"AE_MYEG_AV01.b1s", "AE_MYEG_AV01.exe.config", "AE_MYEG_AV01.pdb", "Customer Selection.srf", "Exception List.srf", "MyEgMenu.xml", "Upload Statement.srf"}
